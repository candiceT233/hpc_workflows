...
#SBATCH --job-name=amp_dh
#SBATCH --output=/scratch/bekn/mtang9/runs/nf-core_ampliseq/small_1n32c_darshan/logs/slurm-%j.out
#SBATCH --error=/scratch/bekn/mtang9/runs/nf-core_ampliseq/small_1n32c_darshan/logs/slurm-%j.err

set -euo pipefail

WIDGET_ROOT=/scratch/bekn/mtang9
RUN_DIR=$WIDGET_ROOT/runs/nf-core_ampliseq/small_1n32c_darshan
...
echo "=== ampliseq Darshan run: $(date -u +%FT%TZ) ==="
echo "Host:        $(hostname)"
